class ZCL_ZCG_USERINFO_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZCG_USERINFO_MPC==========CP' ##NO_TEXT.
...
CLASS ZCL_ZCG_USERINFO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCG_USERINFO_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Age' iv_abap_fieldname = 'AGE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCG_USER'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210313130112'.                  "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Age'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'USERS'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
